...
export default function Sidebar() {
    ...
    return (
            ...
            <nav className={styles.nav}>
                ...
                >
                    <span className={styles.icon}>
                        <svg viewBox="0 0 24 24" aria-hidden="true">
                            <path d="M3.5 10.8 12 4l8.5 6.8v8.7c0 .8-.7 1.5-1.5 1.5h-4.2v-5.4H9.2V21H5c-.8 0-1.5-.7-1.5-1.5v-8.7Z" />
                        </svg>
                    </span>
                ...
                >
                    <span className={styles.icon}>
                        <svg viewBox="0 0 98.751 98.75" aria-hidden="true" fill="currentColor">
        ...
        M87.335,58.067v-1.98c0.212-0.057,0.412-0.135,0.599-0.244l1.396,1.4C88.758,57.674,88.08,57.965,87.335,58.067z
        M90.182,56.411l-1.408-1.408c0.107-0.185,0.199-0.382,0.256-0.596h1.972C90.896,55.152,90.616,55.84,90.182,56.411z
        M89.029,53.219c-0.055-0.215-0.139-0.418-0.248-0.605l1.4-1.4c0.435,0.575,0.721,1.256,0.822,2.006H89.029L89.029,53.219z" />
                        </svg>
                ...
                >
                    <span className={styles.icon}>
                        <svg viewBox="0 0 391.285 391.285" aria-hidden="true" fill="currentColor">
        ...
        c-12.086,3.179-23.502,6.181-33.443,9.155c-16.244,4.864-33.916,9.454-52.648,13.678
        c18.221-44.276,44.697-85.143,69.117-106.392c0,0,100.499,0,109.527,0s14.955,3.781,15,11.143
        C235.745,159.292,222.635,176.162,196.78,191.544z" />
